...
//  SetGame
//
//  Created by ariez on 29.07.20.
//  From https://stackoverflow.com/questions/57763709/swiftui-withanimation-completion-callback
//
...
extension View {
    func afterAnimCompletes(on data: Double, callback: @escaping () -> ()) -> some View {
        self.modifier(AnimatableModifierDouble(bindedValue: data, completion: callback))
    }
}
